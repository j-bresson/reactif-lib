...
(defclass ReactiveCollBox (OMReactiveBox OMBoxcall) 
  ((memory :initform nil :accessor memory)))

(defmethod omNG-box-value ((self ReactiveCollBox) &optional (numout 0)) 
 ;(print (list "EVAL" self (memory self)))
 (setf (value self) 
